...
def second_win():
    ...
    label_1=Label(window,text="Registration Completed",relief="solid",font=("arial", 12,"bold")).place(x=30,y=70)
    b1=Button(window,text="login",width=12,bg='brown',fg='white',command=abt1).place(x=80,y=110)
    window.mainloop()
